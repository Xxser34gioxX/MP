...
public class PayableInterfaceTest 
{
   public static void main( String[] args )
   {
      ...
      payableObjects[ 4 ] = new HourlyEmployee( "Mark", "Taylor", "333-33-3333", 20.00, 45 ); // 45 horas trabajadas
      payableObjects[ 5 ] = new HourlyEmployee( "Sarah", "Johnson", "444-44-4444", 18.00, 38 ); // 38 horas trabajadas
